    ...
    for step in range(H.train_steps):
        ...
        if H.amp:
            ...
            torch.nn.utils.clip_grad_norm_(
                vqgan.ae.generator.logsigma.parameters(), 0.1
            )
            optim.step()
        ...
        if step % H.steps_per_eval == 0 and step > 0:
            ...
            with torch.no_grad():
                ...
                for x_val in tqdm(val_loader, total=len(val_loader)):
                    ...
                    nl_p_x = nl_p_x_z + nl_p_z + float(math.log(32.0) * pixels)  # 5 bit
...
if __name__ == "__main__":
    ...
    if H.load_step and H.steps_per_eval:
        ...
        log(
            "Please specify how often to approximate ELBO using the --steps_per_eval flag"
        )
